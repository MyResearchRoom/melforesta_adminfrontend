...
export default function CancelOrderViewDetail() {
    const {id} =useParams();
  ...
  return (
  <section className="px-2 pr-4 md:px-6 py-6 min-h-screen bg-gradient-to-br from-gray-100 to-gray-200">

  <div className='flex flex-col md:flex-row justify-between items-start pb-5 lg:pb-7 gap-3'>
    <div
