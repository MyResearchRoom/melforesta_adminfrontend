...
export default function AdminReturnOrderViewDetail() {
  const {id} =useParams();
    ...
    <div className="mt-5 bg-white shadow-md rounded-lg p-4 border">
      ...
      <div className="flex justify-between flex-wrap gap-4">
        <div className="space-y-1">
          ...
          <p className="text-sm font-medium">Return Reason: <span className="text-gray-700 text-">{returnProduct.reason}</span></p>
          ...
          {returnProduct?.returnStatus === "rejected" &&  (
            <p className="text-sm font-medium capitalize">Reject Reason: <span className="text-red-600">{returnProduct.returnActionReason}</span></p>
          )}
        </div>
